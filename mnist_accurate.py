...
# create a lot of weights and biases
# One should generally initialize weights with a small amount of noise for symmetry breaking, 
# and to prevent 0 gradients. initialize them with a slightly positive initial bias to avoid "dead neurons".
...
# we first reshape x to a 4d tensor(784 = 28*28), with the second and third dimensions corresponding to image width and height, 
